...
def structure_metrics_from_columns_enhanced(county_data):
    ...
    for col in metric_columns:
        ...
        if len(parts) >= 2:
            ...
            if top_level == 'people':
                mapped_category = 'people'
            elif top_level == 'prosperity':
                mapped_category = 'prosperity'
            elif top_level == 'planet':
                mapped_category = 'planet'
            else:
...
# Radar chart section with SVG background + radar overlay
html.Div([
    html.Div([
        # SVG background (static canvas)
        html.Embed(
            src="/assets/custom_visual.svg",
            type="image/svg+xml",
            style={
                'position': 'absolute',
                'top': '0',
        ...
        # Radar chart (interactive overlay)
        dcc.Graph(
            id='radar-chart',
            ...
            html.Div([
                ...
                html.Div([
                    ...
                    html.Ul([
                        ...
                        html.Li("People (Blue), Prosperity (Red), Planet (Green)"),
